...
<section class="hero_banner_sec">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="whislist_icon1">
                  {{ $item->productremark == "none" ? "" : $item->productremark }}
                    </div>
                  ...
                  <div class="product_text">
                    ...
                    <li><a href="{{ route('single.product', $item->id) }}">{{ $item->title }}</a></li>
                      <li><a href="{{ route('single.product', $item->id) }}">${{$item->price}}</a></li>

                    </ul>
                    <a href="{{ route('single.product', $item->id) }}">{{$item->summary}}<a href="{{ route('single.product', $item->id) }}">
                    @if (Route::has('login'))
      ...
      <section class="services_sec pro_serv">
        <div class="container">
          ...
          <div class="row">
          {{-- {{ $products }} --}}
            @foreach ($servicelatest as $key=> $items)
...
<div class="custom_input">
                ...
                <div class="custom_input">
                  ...
                  <span  id="yourQuery-error"  class="error"></span>
                </div>
