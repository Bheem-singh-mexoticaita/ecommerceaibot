<div class="sidepanel-inner d-flex flex-column">
    ...
    <div class="app-branding">
        <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="{{ asset('backend/assets/images/app-logo.svg') }}"
    ...
    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            <li class="nav-item">
                ...
                <a class="nav-link {{ request()->routeIs('admin.dashboard') ? 'active':'' }}"  href="index.html">
                    <span class="nav-icon">
                ...
                <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                    <ul class="submenu-list list-unstyled">
                        <li class="submenu-item">
                            <a class="submenu-link {{ request()->routeIs('admin.all.category') ? 'active':'' }}"
                                href="{{ route('admin.all.category') }}">Catagory Management</a></li>
