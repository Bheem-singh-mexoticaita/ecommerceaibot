...
class SubcatagoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.Pages.ProductManagement.subcatagory.subcategory_view', compact('subcategory'));
    ...
    public function create()
    {
        ...
        return view('admin.Pages.ProductManagement.subcatagory.subcategory_add', compact('category'));
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.Pages.ProductManagement.subcatagory.subcategory_edit',compact('category', 'subcategory'));
